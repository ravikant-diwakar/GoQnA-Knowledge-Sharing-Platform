  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        {/* User header */}
        <div className="p-4 sm:p-8 bg-gradient-to-r from-indigo-50 to-blue-50 border-b border-gray-200">
          <div className="flex flex-col items-center sm:flex-row sm:items-center">
            ...
            <div className="flex-1 text-center sm:text-left">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <h1 className="text-2xl font-bold text-gray-900 mb-2 sm:mb-0">{user.displayName}</h1>
                {isCurrentUser && (
                  <Link 
                    to="/settings/profile" 
                    className="inline-flex items-center px-3 py-1.5 border border-gray-300 text-sm font-medium rounded-md bg-white text-gray-700 hover:bg-gray-50 shadow-sm"
                  >
              ...
              <div className="flex flex-col items-center sm:items-start space-y-1 mt-2">
              ...
              <div className="mt-4 grid grid-cols-2 gap-3 sm:flex sm:flex-wrap sm:gap-4">
                <div className="bg-white shadow-sm rounded-lg px-3 py-2 border border-gray-200">
                      ...
                      {questions.slice(0, 3).map((question) => (
                        <li key={question.id} className="py-3">
                          <Link 
                            ...
                            className="text-indigo-600 hover:text-indigo-800 font-medium line-clamp-2"
                          >
                            {question.title}
                          </Link>
